...
if (document.getElementsByClassName('demo').length > 0) {
	...
	Aqui você conhece alguns dos meus trabahos e tecnologias que utilizo para desenvolver meus projetos.

	Gostou? Então não deixe de entrar em contato.

	- Websites;
	- Sistemas de gestão online;
	- Portfolio profissional;
	- Websites promocionais;
	- Web Scrapings;
